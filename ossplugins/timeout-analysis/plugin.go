...
func (p *Plugin) Name() string { return "timeout-analysis" }
func (p *Plugin) Init(ctx pluginsdk.Context) error {
	p.ctx = ctx
	p.ep = NewTimeoutAnalysisProcessor(ctx.Ctx)
	return nil
}
...
func init() { pluginloader.Register("timeout-analysis", func() pluginsdk.Plugin { return &Plugin{} }) }
