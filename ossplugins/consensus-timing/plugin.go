...
func (p *Plugin) Name() string { return "consensus-timing" }
func (p *Plugin) Init(ctx pluginsdk.Context) error {
	p.ctx = ctx
	p.ep = NewConsensusTimingProcessor(ctx.Ctx)
	return nil
}
...
func init() { pluginloader.Register("consensus-timing", func() pluginsdk.Plugin { return &Plugin{} }) }
