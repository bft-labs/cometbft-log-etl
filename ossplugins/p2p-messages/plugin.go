...
func (p *Plugin) Name() string { return "p2p-messages" }
func (p *Plugin) Init(ctx pluginsdk.Context) error {
	p.ctx = ctx
	p.ep = NewP2pMessageProcessor(ctx.Ctx)
	return nil
}
...
func init() { pluginloader.Register("p2p-messages", func() pluginsdk.Plugin { return &Plugin{} }) }
